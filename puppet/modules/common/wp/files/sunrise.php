...
// below code from sunrise.php from wordpress-mu-domain-mapping plugin version 0.5.4.2.
//     (see http://wordpress.org/extend/plugins/wordpress-mu-domain-mapping/installation/)
